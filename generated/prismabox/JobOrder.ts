...
export const JobOrderPlain = t.Object(
  {
    ...
    jobDescription: __nullable__(t.String()),
    pricePerUnit: __nullable__(t.Number()),
...
export const JobOrderPlainInputCreate = t.Object(
  {
    ...
    jobDescription: t.Optional(__nullable__(t.String())),
    pricePerUnit: t.Optional(__nullable__(t.Number())),
    dueDate: t.Optional(__nullable__(t.Date())),
    billPicture: t.Optional(__nullable__(t.String())),
  ...
  t.Object(
    {
      ...
      weight: t.Boolean(),
      jobDescription: t.Boolean(),
      pricePerUnit: t.Boolean(),
      dueDate: t.Boolean(),
      billPicture: t.Boolean(),
      status: t.Boolean(),
      remarks: t.Boolean(),
      createdAt: t.Boolean(),
      updatedAt: t.Boolean(),
  ...
  t.Object(
    {
      ...
      jobDescription: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      pricePerUnit: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      dueDate: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
      billPicture: t.Union([t.Literal("asc"), t.Literal("desc")], {
        additionalProperties: false,
      }),
